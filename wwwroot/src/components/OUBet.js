        ...
        <div className="the-box">
            <div className="form-group">
                ...
                <div className="input-group">
                    <span className="input-group-addon">
                        <span className="dropdown-toggle hand" data-toggle="dropdown" data-bind="text: coinName"></span>
                        ...
                        </ul> <span className="caret"></span>
                    </span>
                    <input type="text" data-bind="value: balance, click: copyBalance" className="form-control hand" readOnly="readonly" />
                    <span className="input-group-addon hand" data-bind="click: refreshBalance"><i className="fa fa-refresh" title="Refresh balance"></i></span>
                </div>
            </div>
            <div className="form-group">
                ...
                <span className="help-block" data-bind="html: amountdesc"></span>
            </div>
            <div className="form-group">
                <label>PAYOUT</label>
                <div className="input-group">
                ...
                <p className="text-danger" data-bind="validationMessage: payout"></p>
            ...
            <div className="row">
                <div className="col-sm-4">
                    <button className="btn btn-success btn-perspective btn-lg"></button>
                </div>

                <div className="col-sm-4">
                    <button className="btn btn-danger btn-perspective btn-lg"></button>
                </div>
                <div className="col-sm-4">
                    <button className="btn btn-warning btn-perspective btn-lg"></button>
                </div>
            </div>
        </div>
