...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        clean: {
            ...
            build: {
                src: ['build', 'public/stylesheets/**/*', "!public/stylesheets/*.min.*.css", 'public/javascripts/app', 'public/javascripts/*.js', 'public/javascripts/debug', 'public/javascripts/libs', "!public/javascripts/*.min.*.js"]
            }
        },
        jshint: {
            options: {
            ...
            client: {
                options: {
                    ...
                    ignores: ['public/javascripts/**/*.min.js']
                },
        ...
        cssmin: {
            build: {
                options: {},
                files: {
                    'public/stylesheets/libs.min.css': ["public/stylesheets/libs/*"]
                }
            }
        },
        less: {
        ...
        uglify: {
            ...
            build: {
                files: {
                    'public/javascripts/libs.min.js': ['public/javascripts/libs/*.js', 'public/javascripts/libs/plugins/jquery.wookmark.min.js', 'public/javascripts/libs/plugins/imagesloaded.pkgd.min.js', 'public/javascripts/libs/plugins/angular-cookies.min.js', 'public/javascripts/libs/plugins/angular-translate.min.js', 'public/javascripts/libs/plugins/angular-translate-loader-url.min.js', 'public/javascripts/libs/plugins/angular-translate-storage-cookie.min.js', 'public/javascripts/libs/plugins/ui-bootstrap-tpls.min.js', 'public/javascripts/libs/plugins/ng-mobile-menu.min.js', 'public/javascripts/libs/plugins/bootstrap.min.js', 'public/javascripts/libs/plugins/moment-with-locales.js'],
                    'public/javascripts/app.min.js': ['public/javascripts/erealm.js', 'public/javascripts/language.js', 'public/javascripts/clients.js', 'public/javascripts/app/*.js']
                }
            }
        },
        useminPrepare: {
        ...
        watch: {
            ...
            clientJS: {
                files: ['public/**/*.js', '!client/app/**/*.min.js'],
