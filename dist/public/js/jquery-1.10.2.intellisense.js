...
intellisense.annotate(jQuery, {
  ...
  'ajaxTransport': function ajaxTransport() {
    /// <signature>
  ...
  'browser.version': function browserVersion() {
...
jQuery.Deferred = function (func) {
  ...
  intellisense.annotate(_object, {
    ...
    'notifyWith': function notifyWith() {
      /// <signature>
    ...
    'rejectWith': function rejectWith() {
      /// <signature>
    ...
    'resolveWith': function resolveWith() {
      /// <signature>
...
intellisense.annotate(jQuery.Event.prototype, {
  ...
  'delegateTarget': function delegateTarget() {
...
intellisense.annotate(jQuery.fn, {
  ...
  'attributeContains': function attributeContains() {
    /// <signature>
  ...
  'attributeContainsPrefix': function attributeContainsPrefix() {
    /// <signature>
  ...
  'attributeContainsWord': function attributeContainsWord() {
    /// <signature>
  ...
  'attributeEndsWith': function attributeEndsWith() {
    /// <signature>
  ...
  'attributeEquals': function attributeEquals() {
    /// <signature>
  ...
  'attributeNotEqual': function attributeNotEqual() {
    /// <signature>
  ...
  'attributeStartsWith': function attributeStartsWith() {
    /// <signature>
  ...
  'next adjacent': function nextAdjacent() {
    /// <signature>
  ...
  'next siblings': function nextSiblings() {
    /// <signature>
  ...
  'nth-last-child': function nthLastChild() {
    /// <signature>
  ...
  'nth-last-of-type': function nthLastOfType() {
    /// <signature>
    ///   <summary>Selects all elements that are the nth-child of their parent, counting from the last element to the first.</summary>
  ...
  'nth-of-type': function nthOfType() {
    /// <signature>
