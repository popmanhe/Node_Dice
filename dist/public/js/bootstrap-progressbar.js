...
!function ($) {
	...
	var ProgressBar = function ProgressBar(element, options) {
		...
		var hasOptions = (typeof options === 'undefined' ? 'undefined' : _typeof(options)) == 'object';
	...
	ProgressBar.prototype = {
		...
		stepIt: function stepIt() {
			if (this.position < this.maximum) this.position += this.step;

			this.setPosition(this.position);
		},

		setWarningMarker: function setWarningMarker(marker) {
		...
		setDangerMarker: function setDangerMarker(marker) {
		...
		setPosition: function setPosition(position) {
			...
			if (position > this.maximum) position = this.maximum;
		...
		_triggerPositionChanged: function _triggerPositionChanged() {
...
//# sourceMappingURL=bootstrap-progressbar.js.map