    ...
    (function (undefined) {
        ...
        (function (factory) {
            ...
            ko.computed = ko.dependentObservable = function (evaluatorFunctionOrOptions, evaluatorFunctionTarget, options) {
                ...
                if (readFunction && (typeof readFunction === 'undefined' ? 'undefined' : _typeof(readFunction)) == "object") {
                ...
                function evaluateImmediate(suppressChangeNotification) {
                    ...
                    if (isSleeping) {
                        try {
                            ...
                            ko.dependencyDetection.begin({
                                callback: function callback(subscribable, id) {
                    ...
                    if (!_dependenciesCount) _dispose();
                }
                ...
                function dependentObservable() {
                    if (arguments.length > 0) {
                        ...
                        if (_needsEvaluation) evaluateImmediate(true /* suppressChangeNotification */);
                        return _latestValue;
                    }
                }
                ...
                function peek() {
                    ...
                    if (_needsEvaluation && !_dependenciesCount) evaluateImmediate(true /* suppressChangeNotification */);
                    return _latestValue;
                }
            ...
            (function () {
                ...
                function mapJsObjectGraph(rootObject, mapInputCallback, visitedObjects) {
                    ...
                    var canHaveProperties = (typeof rootObject === 'undefined' ? 'undefined' : _typeof(rootObject)) == "object" && rootObject !== null && rootObject !== undefined && !(rootObject instanceof Date) && !(rootObject instanceof String) && !(rootObject instanceof Number) && !(rootObject instanceof Boolean);
                    ...
                    if (toks) {
                        ...
                        for (var i = 0, tok; tok = toks[i]; ++i) {
                            ...
                            if (c === 44) {
                                // ","
                                if (depth <= 0) {
                                    if (key) result.push(values ? { key: key, value: values.join('') } : { 'unknown': key });
                                    key = values = depth = 0;
                                    continue;
                                }
            ...
            (function (undefined) {
                ...
                function createViewModel(componentDefinition, element, componentParams) {
                    ...
                    return componentViewModelFactory ? componentViewModelFactory.call(componentDefinition, componentParams, { element: element }) : componentParams; // Template-only component
                }
            })();
...
//# sourceMappingURL=knockout-3.2.0.debug.js.map